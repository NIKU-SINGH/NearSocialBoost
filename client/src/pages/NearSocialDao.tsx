...
import { Text, Button,Table } from "@geist-ui/core";
...
const NearSocialDao = () => {
  ...
  const editionDropAddress = "0xc8f5acE690b4D71376ECC7d0ad88B9295a26FEe5";
  ...
  const { contract: token } = useContract(
    "0x0Cf1e2C60FE1823997A4E09bcd45ed877897B4A9",
    "token"
  );
  const { contract: vote } = useContract(
    "0xECBDc6F94aBDB6Ed1440CD50B78939Ca4886eB81",
    "vote"
  );
    ...
    return (
      <div className="unsupported-network flex flex-col justify-center">
        ...
        <Text h5 blockquote type="warning">
          The DAO is built on the AuroraTestnet network, please switch networks
    ...
    return (
      <div className="landing">
        <Text h1 style={{ textAlign: "center" }}>
          Welcome to Near Social Boost DAO
        </Text>
